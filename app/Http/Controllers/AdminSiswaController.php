<?php namespace App\Http\Controllers;
	...
	class AdminSiswaController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>'Nama Siswa','name'=>'nama_siswa','type'=>'text','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Tempat Lahir Siswa','name'=>'tempat_lahir_siswa','type'=>'text','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Tanggal Lahir Siswa','name'=>'tanggal_lahir_siswa','type'=>'date','validation'=>'date','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Foto Siswa','name'=>'foto_siswa','type'=>'upload','validation'=>'image|required','width'=>'col-sm-10'];
	        ...
	        */
	        ...
	        $this->index_statistic[] = ['label'=>'Total Data','count'=>DB::table('siswa')->count(),'color'=>'primary'];
